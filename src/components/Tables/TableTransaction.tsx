...
const TableTransaction: React.FC<{ count: number }> = ({ count }) => {
    ...
    <div className="rounded-[10px] bg-white px-7.5 pb-4 pt-7.5 shadow-1 dark:bg-gray-dark dark:shadow-card">
      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-2 sm:grid-cols-7">
          ...
          <div className="hidden px-1 pb-3.5 text-center sm:block">
            <h5 className="text-sm font-medium uppercase xsm:text-base">
              CURRENCY
            </h5>
          </div>
        ...
        {(transactions as any[]).map((transaction, key) => (
          ...
          >
            ...
            <div className="hidden items-center justify-center px-1 py-4 sm:flex">
                    <button onClick={() => handleDelete(transaction.id)}className="hover:text-primary">
                      <svg
